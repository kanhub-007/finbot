"""TradingControlMixin — manual orders, leverage, config, risk orders.

Extracted from BotManager to keep file sizes manageable. All methods access
state via self (the BotManager instance that mixes this in).
"""
...
class TradingControlMixin:
    """Manual orders, leverage, config, risk orders.

    Mixed into BotManager. All methods access state via self.
    """
