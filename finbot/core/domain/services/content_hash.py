...
Pure domain functions — no filesystem, network, or database access.
For strategy file hashing (filesystem I/O), see
``finbot.infrastructure.services.strategy_file_hasher``.
"""
